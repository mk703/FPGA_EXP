...
vcom -93 -work work {E:/FPGA_EXP5/mystorage.vhd}
vcom -93 -work work {E:/FPGA_EXP5/FPGA_EXP5.vhd}
vcom -93 -work work {E:/FPGA_EXP5/counter.vhd}

vcom -93 -work work {E:/FPGA_EXP5/FPGA_EXP5_tb.vhd}

vsim -t 1ps -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cyclonev -L rtl_work -L work -voptargs="+acc"  FPGA_EXP5_tb
