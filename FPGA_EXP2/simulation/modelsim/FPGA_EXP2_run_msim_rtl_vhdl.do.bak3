...
vcom -93 -work work {D:/FPGA_EXP2/Generater.vhd}
vcom -93 -work work {D:/FPGA_EXP2/Detector.vhd}
vcom -93 -work work {D:/FPGA_EXP2/FPGA_EXP2.vhd}

vcom -93 -work work {D:/FPGA_EXP2/FPGA_EXP2_tb.vhd}

vsim -t 1ps -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cyclonev -L rtl_work -L work -voptargs="+acc"  FPGA_EXP2_tb
